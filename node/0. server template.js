  ...
  switch (request.url) {
    case "/":
      ...
      case "/rand_student":
        fs.readFile(
          ...
          (err, template) => {    
            if (err) {            
              ...
              getRandomUser(user);
              const renderHtml = user.map((item, index) => `
              <div class="block">
		<div class="header">
		...
		<div class="main">
			<div class="group">Group: П${item.group}</div>
			<div class="main-alm">
				<div class="pokaz">
					<img src="img/almz.jpeg" class="main-img">
					<div class="text-img">${item.almz}</div>
					
				</div>
				<div class="pokaz">
					<img src="img/mon.png" class="main-img">
					<div class="text-img">${item.coin}</div>
					
				</div>
				<div class="pokaz">
					<img src="img/Mail.png" class="main-img">
					<div class="text-img">${item.star}</div>
					
				</div>
				<div class="pokaz">
					<img src="img/med.webp" class="main-img">
					<div class="text-img">${item.med}</div>
					
				</div>
			</div>
			<div class="avg-grade">
				<div class="grade">${item.avg_grade}</div>
				<div class="text-grade">Average Grade</div>
			</div>
			<div class="avg-grade">
				<div class="grade">${item.visit}</div>
				<div class="text-grade">Visit %</div>
			</div>
			<div class="stand-div">AGE: </div>
			<div class="stand-div">email: ${item.age}@gmail.com</div>
			<div class="stand-div">number: 37529${item.number}</div>
			<div class="stand-div">password: ${item.passw}</div>
